...
export function buttonFilterSlider_click_1(event) {
...
*/
export function buttonResetFilter_click_1(event) {
...
*	 @param {$w.MouseEvent} event
*/
export function buttonResetSort_click_1(event) {
...
*	 @param {$w.Event} event
*/
export function radioGroupSort_change_1(event) {
